    ...
    handleOnClick(e){
      switch(e.currentTarget.id){
          ...
          case "start_stop":
            ...
            if(this.timer == null) //no queremos crear un timer nuevo cada vez
              this.timer = setInterval(()=>{
                ...
                else if(this.state.time_left == 0){ //vamos alternando entre periodos trabajo-pausa
          ...
          case "reset":          
            ...
            this.setState(Object.assign({},initial_state)); //queremos una copia del objeto initial_state
            break;
      }
    }
            ...
            <div class="col-5">
              <div id="clock">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <ParamControlComponent value={this.state.session_length} onClick={this.handleOnClick} control_name="session" label="Duración de la sessión" />
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
